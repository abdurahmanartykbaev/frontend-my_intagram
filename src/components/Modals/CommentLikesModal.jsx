...
import { commentLikesModalState } from '../../ModalStates/modalStates';
import { commentIdState, photoIdState } from '../../ModalStates/idStates';
  ...
  useEffect(() => {
    if (open) {
      const getUsers = async () => {
        const result = await getCommentLikedUsers(photoId, commentId);
        result.map((res) => {
